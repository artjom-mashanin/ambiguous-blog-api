...
const posts = [
  {
    ...
    content:
      'Express.js is a minimal and flexible Node.js web application framework that provides a robust set of features for web and mobile applications. In this post, we will explore the basics of setting up an Express server.',
  ...
  },
  {
    ...
    content:
      'REST (Representational State Transfer) is an architectural style for designing networked applications. This guide covers best practices for building RESTful APIs with proper HTTP methods and status codes.',
  ...
  },
  {
    ...
    content:
      'This is a draft post about upcoming features we are planning to add to the blog platform.',
    authorName: 'Jane Developer',
    status: 'draft',
